...
public class FetchStockUbicacion extends AbstractMessageTransformer {
	...
	public Object transformMessage(MuleMessage message, String outputEncoding) throws TransformerException {
		...
		Integer codigo =  Integer.valueOf(message.getInvocationProperty("codigo"));
		...
		try {
			...
			String OrderQuery = "SELECT "+sociedad+".OIBQ.\"ItemCode\", "+sociedad+".OIBQ.\"BinAbs\", "+sociedad+".OIBQ.\"OnHandQty\", "+sociedad+".OIBQ.\"WhsCode\""
					...
					+ " AND "  + sociedad +".OIBQ.\"BinAbs\" = '"+codigo+"'";
	...
	public ArrayList<HashMap<String, Object>> parseQuery(ResultSet set) throws SQLException {
		...
		while (set.next() != false) {
			...
			answer.put("codigobarras", set.getString("CodeBars"));

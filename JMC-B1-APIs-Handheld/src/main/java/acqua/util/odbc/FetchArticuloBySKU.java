...
public class FetchArticuloBySKU extends AbstractMessageTransformer {
	...
	public Object transformMessage(MuleMessage message, String outputEncoding) throws TransformerException {
		...
		try {
			...
			// Query
			String Query = "SELECT \"ItemCode\", \"ItemName\", \"CodeBars\", \"SWW\" FROM "+sociedad+".OITM Where \"ItemCode\" = '"+ codigo + "'";
	...
	public HashMap<String, Object> parseQuery(ResultSet set) throws SQLException {
		...
		while (set.next() != false) {
			...
			answer.put("codigo", set.getString(1));
			answer.put("descripcion", set.getString(2));
			answer.put("codigobarra", set.getString(3));
			answer.put("codigotango", set.getString(4));

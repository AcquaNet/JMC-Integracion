...
public class FetchStockArticulo extends AbstractMessageTransformer {
	...
	public Object transformMessage(MuleMessage message, String outputEncoding) throws TransformerException {
		...
		try {
			...
			// Fetch OIBQ data
			String OrderQuery = "SELECT "+sociedad+".OIBQ.\"ItemCode\", "+sociedad+".OIBQ.\"BinAbs\", "+sociedad+".OIBQ.\"OnHandQty\", "+sociedad+".OIBQ.\"WhsCode\", "+sociedad+".OIBQ.\"Freezed\", "+sociedad+".OBIN.\"BinCode\" FROM "+ sociedad + ".OIBQ, "+sociedad+".OBIN WHERE "
					+ sociedad +".OIBQ.\"BinAbs\" = "+sociedad+".OBIN.\"AbsEntry\""
					+ " AND "+sociedad+".OIBQ.\"Freezed\" = 'N' AND "+sociedad+".OIBQ.\"ItemCode\" = '"+codigo+"'";

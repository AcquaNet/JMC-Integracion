...
public class FetchArticuloByCode extends AbstractMessageTransformer {
	...
	public Object transformMessage(MuleMessage message, String outputEncoding) throws TransformerException {
		...
		try {
			...
			// Query
			String Query = "SELECT \"ItemCode\", \"ItemName\", \"CodeBars\", \"SWW\" FROM "+sociedad+".OITM Where \"SWW\" = '"+ codigo + "'";
